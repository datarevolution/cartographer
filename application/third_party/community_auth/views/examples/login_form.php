...
<fieldset>
		...
		<p><label for="login_string" class="form_label">Username or Email</label></p>
		<input type="text" name="login_string" id="login_string" class="form_input" autocomplete="off" maxlength="255" />


		<p><label for="login_pass" class="form_label">Password</label></p>
		...
		?>
			...
			<p><label for="remember_me" class="form_label">Remember Me</label></p>
