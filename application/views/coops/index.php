...
var json =  $.getJSON("<?php echo $this->config->base_url(); ?>/index.php/coops/json/", function(data) {
	$.each(data['places'], function(key, value) {
		...
		$.each(value['coops'], function (c_key, c_value) {
			coopCount++;
			popupContent = popupContent + "<div class=\"coop_info\"><h3><i class=\"fa " + c_value['icon'] + " fa-1g\"></i><a href=\"" + c_value['url'] + "\">" + c_key + "</a></h3><p class=\"edit\"><a href=\"coops/edit/" + c_value['id'] + "\">[edit]</a> - <a href=\"coops/delete/" + c_value['id'] + "\">[delete]</a></p><p>" + c_value['description'] + "</p></div>";
		});
